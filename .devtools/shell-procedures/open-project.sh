...
$PROC_PATH/upload-changes.sh documentation-builder
$PROC_PATH/upload-changes.sh ratman-dataedit
$PROC_PATH/upload-changes.sh branching-chainer
$PROC_PATH/upload-changes.sh rattish
